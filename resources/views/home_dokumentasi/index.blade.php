                        ...
                        <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>Target</td>
                                    <td>
                                        <a href=""> <i class="material-icons col-teal">border_color</i> </a>  
                                    </td>
                                </tr>
                                    @for($x=0; $x < 3; $x++)
                                    <tr>
                                        <td>{{ $a++ }}</td>
                                        <td>Realisasi</td>
                                        <td style="padding-left: 30px">Target</td>
                                        <td>
                                            <a href=""> <i class="material-icons col-teal">border_color</i> </a>  
                                            <a href=""><i class="material-icons col-pink">delete</i> </a>
                                        </td>
                                    </tr>
                                        @for($z=0; $z < 3; $z++)
                                        <tr>
                                            <td>{{ $a++ }}</td>
                                            <td>Realisasi</td>
                                            <td style="padding-left: 60px">Target</td>
                                            <td>
                                                <a href=""> <i class="material-icons col-teal">border_color</i> </a>  
                                                <a href=""><i class="material-icons col-pink">delete</i> </a>
                                            </td>
